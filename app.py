...
#---------Report Downloading in PDF format step---------
...
# ── Page config ──────────────────────────────────────────────────────────────
st.set_page_config(
    page_title="Deep Scholar · AI Research Agent",
    page_icon="🔬",
    layout="wide",
...
st.markdown("""
<style>
@import url('https://fonts.googleapis.com/css2?family=Exo+2:wght@600;700;800&family=DM+Mono:wght@300;400;500&family=DM+Sans:wght@300;400;500&display=swap');
...
st.markdown("""
<div class="notice">
    Deep Scholar · AI-Powered Multi-Agent Research System · Developed by Harsh Saxena
</div>
""", unsafe_allow_html=True)